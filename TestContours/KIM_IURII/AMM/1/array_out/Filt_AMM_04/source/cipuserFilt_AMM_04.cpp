...
#define MEDOSIZE    280000
	...
	HPutPElem(proc_handle, 1, hv_Tuple_Avg_CMax.DArr(), (INT4_8)(hv_Tuple_Avg_CMax.Length()), DOUBLE_PAR);
	HPutPElem(proc_handle, 2, hv_Tuple_Avg_CMin.DArr(), (INT4_8)(hv_Tuple_Avg_CMin.Length()), DOUBLE_PAR);
	HPutPElem(proc_handle, 3, hv_Tuple_Avg_MM_Th.DArr(), (INT4_8)(hv_Tuple_Avg_MM_Th.Length()), DOUBLE_PAR);
